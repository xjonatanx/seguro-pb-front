...
<template>
  <div class="min-h-screen bg-slate-50 flex items-center justify-center p-4 font-sans text-slate-900">
    <div class="bg-white p-10 rounded-[2.5rem] shadow-2xl w-full max-w-md border-t-[12px] border-blue-900">
      ...
      <div class="bg-amber-50 border-l-4 border-amber-500 p-4 rounded-r-xl shadow-sm mb-8">
      ...
      <div class="space-y-6">
        <div>
          <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1 block mb-2">
            RUT del Trabajador
          </label>
          <input v-model="loginForm.rut" placeholder="12.345.678-9" maxlength="12"
        ...
        <button @click="enterForm" :disabled="loading"
