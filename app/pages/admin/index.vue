...
.input-style {
  @apply w-full bg-slate-50 border-2 border-slate-100 p-4 rounded-2xl focus:border-blue-900 focus:bg-white outline-none font-bold text-slate-700;
}

.btn-primary {
  @apply w-full bg-blue-900 text-white py-5 rounded-2xl font-black hover:bg-blue-800 transition-all shadow-xl disabled:opacity-50 uppercase text-xs;
}

.btn-nav {
  @apply px-4 py-2 rounded-lg border-2 border-slate-200 text-[10px] font-black uppercase tracking-widest disabled:opacity-30 hover:bg-white transition-all shadow-sm;
}

.input-edit {
  @apply w-full bg-white border-2 border-slate-200 p-3 rounded-xl focus:border-blue-900 outline-none font-medium text-sm transition-all;
}

.input-edit::placeholder {
  @apply text-slate-300 font-normal italic;
}

.label-style {
  @apply text-[9px] font-black text-slate-400 uppercase tracking-[0.1em] block mb-1 ml-1;
}
